...
namespace XMonitor_GUI
{
    ...
    public partial class WaypointWindow : UserControl
    {
        ...
        public WaypointWindow(int id, PointData _waypoint)
        {
            ...
            M_IfPaizhao_Action.Items.Add("否");
            M_IfPaizhao_Action.Items.Add("是");
            M_IfPaizhao_Action.SelectedIndex = 0;
            M_IfHangxiangzizhu_Action.Items.Add("否");
            M_IfHangxiangzizhu_Action.Items.Add("是");
            M_IfHangxiangzizhu_Action.SelectedIndex = 0;
            M_IfGaoduzizhu_Action.Items.Add("否");
            M_IfGaoduzizhu_Action.Items.Add("是");
            M_IfGaoduzizhu_Action.SelectedIndex = 0;
            M_IfRenwuxunhuan_Action.Items.Add("否");
            M_IfRenwuxunhuan_Action.Items.Add("是");
            M_IfRenwuxunhuan_Action.SelectedIndex = 0;

            M_JiaoduAuto_Make.Items.Add("否");
            M_JiaoduAuto_Make.Items.Add("是");
            M_JiaoduAuto_Make.SelectedIndex = 0;

            M_Ifreback_Action.Items.Add("否");
            M_Ifreback_Action.Items.Add("是");
